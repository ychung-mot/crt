...
BEGIN TRY
  ...
  insert into CRT_REGION ("REGION_ID",
      "REGION_NUMBER",
      "REGION_NAME", 
      "END_DATE",
      "CONCURRENCY_CONTROL_NUMBER")
...
BEGIN TRY
  ...
  update CRT_REGION
    ...
    from CRT_REGION
    inner join inserted
    on (CRT_REGION.REGION_NUMBER = inserted.REGION_NUMBER);
...
BEGIN TRY
  ...
  update CRT_SERVICE_AREA
    ...
    inner join inserted
    on (CRT_SERVICE_AREA.SERVICE_AREA_NUMBER = inserted.SERVICE_AREA_NUMBER);
...
BEGIN TRY
  ...
  update CRT_DISTRICT
    ...
    from CRT_DISTRICT
    inner join inserted
    on (CRT_DISTRICT.DISTRICT_NUMBER = inserted.DISTRICT_NUMBER);
