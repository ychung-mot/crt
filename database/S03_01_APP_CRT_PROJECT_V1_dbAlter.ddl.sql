...
CREATE TABLE [dbo].[CRT_TENDER] (
    ...
    [PROJECT_ID] NUMERIC(9) NOT NULL,
    [TENDER_NUMBER] NUMERIC(9) NOT NULL,
    [PLANNED_DATE] DATE DEFAULT '0' NOT NULL,
    [ACTUAL_DATE] DATE,
...
SET @curr_date = getutcdate();
  ...
  IF EXISTS(SELECT * FROM inserted)
    insert into CRT_TENDER_HIST ([TENDER_ID], [PROJECT_ID], [TENDER_NUMBER], [PLANNED_DATE], [ACTUAL_DATE], [TENDER_VALUE], [WINNING_CNTRCTR_LKUP_ID], [END_DATE], [COMMENT], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_USERID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_GUID], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_GUID], [DB_AUDIT_CREATE_USERID], [DB_AUDIT_CREATE_TIMESTAMP], [DB_AUDIT_LAST_UPDATE_USERID], [DB_AUDIT_LAST_UPDATE_TIMESTAMP], [TENDER_HIST_ID], [END_DATE_HIST], [EFFECTIVE_DATE_HIST])
 
	select [TENDER_ID], [PROJECT_ID], [TENDER_NUMBER], [PLANNED_DATE], [ACTUAL_DATE], [TENDER_VALUE], [WINNING_CNTRCTR_LKUP_ID], [COMMENT], [END_DATE], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_USERID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_GUID], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_GUID], [DB_AUDIT_CREATE_USERID], [DB_AUDIT_CREATE_TIMESTAMP], [DB_AUDIT_LAST_UPDATE_USERID], [DB_AUDIT_LAST_UPDATE_TIMESTAMP], (next value for [dbo].[CRT_TENDER_H_ID_SEQ]) as [TENDER_HIST_ID], null as [END_DATE_HIST], @curr_date as [EFFECTIVE_DATE_HIST] from inserted;
